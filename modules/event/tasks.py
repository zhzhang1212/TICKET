...
def confirm_booking_task(self, user_id: str, resource_id: str, slot_id: str, voucher: str, record_id: str):
    """
    ...
    try:
        ...
        sync_redis.hset(f"user_tickets:{user_id}", record_id, json.dumps(ticket_info))
        
        # 落库成功！推送成功给 Redis PubSub 频道
        msg = {
            "status": "success", 
            "msg": f"落库成功（凭证：{voucher}）"
        }
